        ...
        private void BtnBaja_Click(object sender, EventArgs e)
        {
            try
            {
                if (lstLibros.SelectedItem != null)
                {
                    ...
                    //Borrado virtual
                    List<Object> libros = new List<object>();
                    libros.Add(lstLibros.SelectedItem);
                    if (result == DialogResult.Yes)
                    {
                        if (control.BorradoVirtual(libros))
                        {
        ...
        private void BtnModificar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (libro != null)
                {
                    ...
                    List<Object> libros = new List<object>();
                    libros.Add(libro);
                    if (control.Modificar(libros))
                    {
                        lstLibros.Items.Insert(lstLibros.SelectedIndex, libro);
                        lstLibros.Items.Remove(lstLibros.SelectedItem);

...
namespace LibreriaV5_1_Final.Comun
{
    class Mensajes
    {
        public static String MSG_LIBRO_NO_ENCONTRADO = "Libro no encontrado";
        public static String MSG_INSERTADO_LIBRO = "Libro insertado correctamente";
        public static String MSG_BORRADO_LIBRO = "Libro borrado correctamente";
        public static String MSG_MODIFICADO_LIBRO = "Libro modificado correctamente";
        public static String MSG_YAEXISTE_LIBRO = "Ese libro ya existe";
        public static String MSG_SELECCIONAR_LIBRO = "Seleccione un libro";

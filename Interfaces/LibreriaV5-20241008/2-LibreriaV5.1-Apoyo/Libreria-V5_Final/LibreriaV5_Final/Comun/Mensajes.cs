...
namespace LibreriaV5_Final.Comun
{
    class Mensajes
    {
        public static String MSG_LIBRO_NO_ENCONTRADO = "Cuadro no encontrado";
        public static String MSG_INSERTADO_LIBRO = "Cuadro insertado correctamente";
        public static String MSG_BORRADO_LIBRO = "Cuadro borrado correctamente";
        public static String MSG_MODIFICADO_LIBRO = "Cuadro modificado correctamente";
        public static String MSG_YAEXISTE_LIBRO = "Ese cuadro ya existe";
        public static String MSG_SELECCIONAR_LIBRO = "Seleccione un cuadro";

        //------CLIENTES--------//

        public static String MSG_CLIENTE_NO_ENCONTRADO = "Cliente no encontrado";
        public static String MSG_INSERTADO_CLIENTE = "Cliente insertado correctamente";
        public static String MSG_BORRADO_CLIENTE = "Cliente borrado correctamente";
        public static String MSG_MODIFICADO_CLIENTE = "Cliente modificado correctamente";
